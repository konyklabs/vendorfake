...
```sh
pip install "vendorfake[serve] @ git+https://github.com/konyklabs/vendorfake@v0.7.0"   # [serve] for `vendorfake serve`; in-process tests need no extra; x-release-please-version  # x-release-please-version
