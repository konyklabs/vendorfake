...
# or, in a uv project: uv add "vendorfake[serve] @ git+https://github.com/konyklabs/vendorfake@v0.7.0"  # x-release-please-version
...
Drop the `@v0.7.0` to track `main` instead of a release tag. <!-- x-release-please-version --> A container image
